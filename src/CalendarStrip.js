...
class DateItem extends PureComponent {
  render() {
    ...
    const normalTextColor = 'rgba(0,0,0,0.0)';
        ...
        >
          <View
            style={[
              ...
              {
                borderBottomColor: highlight ? highlightColor : normalTextColor,
              },
              containerDateStyle,
            ]}
          >
...
class CalendarStrip extends Component {
  static defaultProps = {
    dateSelectedStyle: undefined,
    dateStyle: undefined,
    dayStyle: undefined,
    daySelectedStyle: undefined,
  };
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <DateItem
              item={item}
              normalColor={normalColor}
              containerDateStyle={containerDateStyle}
              dateStyle={dateStyle}
              highlightColor={highlightColor}
              showLunar={false}
